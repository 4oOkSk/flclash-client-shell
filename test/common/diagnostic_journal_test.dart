...
void main() {
      ...
      final upload = DiagnosticUpload((body) async {
        switch (body['action']) {
          ...
          case 'chunk':
            ...
            chunks++;
          case 'status':
            return '{"ret":1,"state":"ready","url":"https://gitlab.com/example/private/-/snippets/42"}';
        }
        return '{"ret":1}';
      }, wait: (_) async {});
  ...
  test(
    ...
    () async {
        ...
        switch (body['action']) {
          ...
          case 'status':
            return jsonEncode({
              'ret': 1,
              'state': 'ready',
              'url': 'https://gitlab.com/example/private/-/snippets/42',
            });
        }
        return '{"ret":1}';
      }, wait: (_) async {});
      expect(
        await upload.upload(bytes),
        'https://gitlab.com/example/private/-/snippets/42',
      );
