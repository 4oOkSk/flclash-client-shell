...
enum ManagedRouteMode {
  @JsonValue('global')
  global,
  @JsonValue('bypass-mainland')
  bypassMainland,
  @JsonValue('bypass-overseas')
  bypassOverseas,
  @JsonValue('direct-all')
  directAllLegacy;
...
enum DashboardWidget {
  privateClientAccount(
    GridItem(crossAxisCellCount: 4, child: PrivateClientAccountCard()),
  ),
  privateClientWebsite(
    GridItem(crossAxisCellCount: 4, child: PrivateClientWebsiteCard()),
  ),
