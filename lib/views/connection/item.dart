...
class TrackerInfoItem extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    final visitedDestination = trackerVisitedDestination(trackerInfo);
    final title = Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          kPrivateClientMode
              ? visitedDestination ?? context.appLocalizations.connected
              : trackerInfo.desc,
          maxLines: 2,
...
class TrackerInfoDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final items = [
      ...
      if (!kPrivateClientMode && trackerInfo.metadata.specialProxy.isNotEmpty)
        _buildItem(
