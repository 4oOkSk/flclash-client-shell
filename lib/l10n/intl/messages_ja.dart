...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "bypassMainland": MessageLookupByLibrary.simpleMessage("中国本土をバイパス"),
    "bypassOverseas": MessageLookupByLibrary.simpleMessage("海外をバイパス"),
    ...
    "clientVisitWebsite": MessageLookupByLibrary.simpleMessage("公式サイトを開く"),
    ...
    "optionNo": MessageLookupByLibrary.simpleMessage("いいえ"),
    "optionYes": MessageLookupByLibrary.simpleMessage("はい"),
    ...
    "privateRuleProviders": MessageLookupByLibrary.simpleMessage("ローカルルールセット"),
    "privateRuleProvidersDesc": MessageLookupByLibrary.simpleMessage(
      "ローカルルーティング専用の HTTPS ルールセットを管理します",
    ),
