...
class AppLocalizations {
  ...
  /// `Share privately on GitLab with maintainers`
  ...
  String get optionYes {
    return Intl.message('Yes', name: 'optionYes', desc: '', args: []);
  }

  /// `No`
  String get optionNo {
    return Intl.message('No', name: 'optionNo', desc: '', args: []);
  }
  ...
  /// `Local rule sets`
  String get privateRuleProviders {
    return Intl.message(
      'Local rule sets',
      name: 'privateRuleProviders',
      desc: '',
      args: [],
    );
  }
  ...
  String get privateRuleProvidersDesc {
    return Intl.message(
      'Manage HTTPS rule sets used only by local routing',
      name: 'privateRuleProvidersDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Rule-set behavior`
  String get privateRuleProviderBehavior {
    return Intl.message(
      'Rule-set behavior',
      name: 'privateRuleProviderBehavior',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Rule-set format`
  String get privateRuleProviderFormat {
    return Intl.message(
      'Rule-set format',
      name: 'privateRuleProviderFormat',
      desc: '',
      args: [],
    );
  }
  ...
  String get privateRuleProviderIntervalDesc {
    return Intl.message(
      'Update interval in seconds (300–604800)',
      name: 'privateRuleProviderIntervalDesc',
      desc: '',
      args: [],
    );
  }
  ...
  String get privateRouteScript {
    return Intl.message(
      'Local routing script',
      name: 'privateRouteScript',
      desc: '',
      args: [],
    );
  }
  ...
  String get privateRouteScriptDesc {
    return Intl.message(
      'The script can edit local rules and rule sets, but cannot access server configuration',
      name: 'privateRouteScriptDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Do not use a script`
  String get privateRouteScriptDisabled {
    return Intl.message(
      'Do not use a script',
      name: 'privateRouteScriptDisabled',
      desc: '',
      args: [],
    );
  }
  ...
  String get privateRouteFallback {
    return Intl.message(
      'The local routing configuration is invalid. Default rules are in use.',
      name: 'privateRouteFallback',
      desc: '',
      args: [],
    );
  }
