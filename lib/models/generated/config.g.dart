...
const _$DashboardWidgetEnumMap = {
  DashboardWidget.privateClientAccount: 'privateClientAccount',
  DashboardWidget.privateClientWebsite: 'privateClientWebsite',
...
_NetworkProps _$NetworkPropsFromJson(Map<String, dynamic> json) =>
    _NetworkProps(
      ...
      managedRouteMode:
          $enumDecodeNullable(
            _$ManagedRouteModeEnumMap,
            json['managedRouteMode'],
          ) ??
...
Map<String, dynamic> _$NetworkPropsToJson(_NetworkProps instance) =>
    <String, dynamic>{
      ...
      'managedRouteMode': _$ManagedRouteModeEnumMap[instance.managedRouteMode]!,
    };
...
const _$ManagedRouteModeEnumMap = {
  ManagedRouteMode.global: 'global',
  ManagedRouteMode.bypassMainland: 'bypass-mainland',
  ManagedRouteMode.bypassOverseas: 'bypass-overseas',
