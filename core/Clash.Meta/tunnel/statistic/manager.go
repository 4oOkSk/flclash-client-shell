...
func (m *Manager) Join(c Tracker) {
	if c.ReportLifecycle() && DefaultRequestNotify != nil {
...
func notifyRequestClose(c Tracker) {
	if c.ReportLifecycle() && DefaultRequestCloseNotify != nil {
		DefaultRequestCloseNotify(c)
	}
}
