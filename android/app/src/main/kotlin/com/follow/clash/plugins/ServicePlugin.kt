...
class ServicePlugin : FlutterPlugin, MethodChannel.MethodCallHandler,
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) = when (call.method) {
        ...
        "getDiagnosticLogs" -> {
            handleGetDiagnosticLogs(result)
        }
    ...
    private fun handleGetDiagnosticLogs(result: MethodChannel.Result) {
        launch {
            val localLogs = GlobalState.getDiagnosticLogs()
            val serviceLogs = Service.getDiagnosticLogs()
            result.success(
                listOf(localLogs, serviceLogs)
