...
class AppPlugin : FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware {
    ...
    override fun onMethodCall(call: MethodCall, result: Result) {
        when (call.method) {
            ...
            "clientSecureStorageRead" -> runCatching {
                ClientSecureStorage.read(GlobalState.application)
            }.fold(result::success) {
            ...
            "clientSecureStorageWrite" -> {
                ...
                if (value == null) {
                    ...
                    runCatching { ClientSecureStorage.write(GlobalState.application, value) }
                        .fold(result::success) {
                            result.error(
            ...
            "clientSecureStorageDelete" -> runCatching {
