...
object State {
    ...
    private val pendingQuickStart = AtomicBoolean(false)
    ...
    fun markPendingQuickStart() {
        pendingQuickStart.set(true)
    }

    fun consumePendingQuickStart(): Boolean {
    ...
    fun launchClientForPendingStart() {
        ...
        GlobalState.application.startActivity(
            Intent(GlobalState.application, MainActivity::class.java).apply {
