...
val releaseStoreFile = file(localProperties.getProperty("storeFile", "keystore.jks"))
val releaseStoreType = localProperties.getProperty("storeType", "JKS")
...
android {
    ...
    defaultConfig {
        applicationId = "com.example.harborproxy"
